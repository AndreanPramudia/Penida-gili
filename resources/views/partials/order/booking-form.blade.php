    ...
    <fieldset data-reveal style="--reveal-delay: 90ms"
        ...
        <div class="mt-[22px] grid [&>*]:min-w-0 gap-[21.6px] sm:grid-cols-2">
            <div class="flex flex-col gap-[5.4px]">
                ...
                <input id="full-name" name="full_name" type="text" placeholder="Enter your full name"
            ...
            <div class="flex flex-col gap-[5.4px] sm:col-span-2">
                ...
                <div class="flex">
                    ...
                    <input id="phone" name="phone" type="tel" placeholder="812 3456 7890"
            ...
            <div class="flex flex-col gap-[5.4px] sm:col-span-2">
                ...
                <textarea id="order-notes" name="notes" rows="3" placeholder="Special requests, large luggage, etc."
                          class="rounded-[11px] border border-[#c0c7d3] bg-[#f7fafc] px-[17.6px] py-[12px] text-[21.6px] leading-[32px] text-editorial-ink placeholder:text-[#6b7280] focus:border-brand focus:outline-none"></textarea>
            </div>
        </div>
    </fieldset>
        ...
        <div class="mt-[22px] grid [&>*]:min-w-0 gap-[21.6px] sm:grid-cols-2">
            @foreach ($order['party'] as $group)
                <div class="flex flex-col gap-[5.4px]">
                    ...
                    <p class="pt-[5.4px] text-[16.2px] leading-[24px] text-editorial-body">{{ $group['price'] }}</p>
                </div>
            @endforeach
        </div>
    </fieldset>
