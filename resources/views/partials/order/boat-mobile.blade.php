...
<form action="{{ $order['action'] }}" method="post" data-quote="{{ json_encode($order['quote']) }}" data-confirm="booking" data-confirm-product="{{ $order['operator'] }}" class="bg-[#f7fafc] lg:hidden">
    @csrf
